...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8 relative overflow-x-hidden w-full">
      
      {/* App Preview Image */}
   <div className="w-full h-[100svh] max-h-screen flex items-center justify-center overflow-hidden">
  <Image
